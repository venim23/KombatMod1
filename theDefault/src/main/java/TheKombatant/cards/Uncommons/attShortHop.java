...
public class attShortHop extends AbstractDynamicKombatCard {
    ...
    public static final String ID = Kombatmod.makeID(attShortHop.class.getSimpleName());
    public static final String IMG = makeCardPath("attShortHop.png");
