...
public class KombatSecondMagicNumberSkill extends AbstractDynamicKombatCard {
     ...
     * variables.DefaultSecondMagicNumber and cards.AbstractKombatCard
     *
    ...
    public static final String ID = Kombatmod.makeID(KombatSecondMagicNumberSkill.class.getSimpleName());
    ...
    public KombatSecondMagicNumberSkill() {
