...
// Skip this question until you start figuring out the AbstractKombatCard/AbstractDynamicKombatCard and just extend DynamicCard
...
public class attHighStrike_s extends AbstractDynamicKombatCard {
    ...
    public static final String ID = Kombatmod.makeID(attHighStrike_s.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attStrike.png");
    // Setting the image as as easy as can possibly be now. You just need to provide the image name
    // and make sure it's in the correct folder. That's all.
    // There's makeCardPath, makeRelicPath, power, orb, event, etc..
    // The list of all of them can be found in the main Kombatmod.java file in the
    ...
    // Go check out KombatAttackWithVariable and TheKombatant.variable.DefaultCustomVariable
    // that's how you get your own custom variable that you can use for anything you like.
    // Feel free to explore other mods to see what variabls they personally have and create your own ones.

    // /STAT DECLARATION/\

    public attHighStrike_s() {
