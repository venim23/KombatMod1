...
public class KombatCommonPower extends AbstractDynamicKombatCard {
    ...
    public static final String ID = Kombatmod.makeID(KombatCommonPower.class.getSimpleName());
