...
public class TheKombatant extends CustomPlayer {
    ...
    public TheKombatant(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(Shinnoks2ndAmuletRelic.ID);
        //retVal.add(ShinnoksAmuletRelic.ID);

        UnlockTracker.markRelicAsSeen(Shinnoks2ndAmuletRelic.ID);
    ...
    public AbstractPlayer newInstance() {
        return new TheKombatant(name, chosenClass);
    }
